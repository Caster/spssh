...
/**
 * Experiment that executes only LocalSearch, in all variants, with skeleton point distribution.
 */
public class LocalSearchExperiment extends Experiment {
    ...
    protected int getNumberOfAlgorithms() {
        return forcetrees.length * forceplanar.length;
    }
